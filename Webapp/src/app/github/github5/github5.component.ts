...
@Component({
  selector: 'app-github5',
  templateUrl: './github5.component.html',
  styleUrls: ['./github5.component.css']
})
export class Github5Component implements OnInit {
