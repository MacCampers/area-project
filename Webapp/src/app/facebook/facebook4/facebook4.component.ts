...
@Component({
  selector: 'app-facebook4',
  templateUrl: './facebook4.component.html',
  styleUrls: ['./facebook4.component.css']
})
export class Facebook4Component implements OnInit {
