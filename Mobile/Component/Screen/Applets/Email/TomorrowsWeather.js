...
export class TomorrowsWeather extends Component {
    constructor () {
        super();
            ...
            <Container>
                <Content>
                    <Card style={{flex: 0, marginLeft: 15, marginRight: 15, marginTop: 15}}>
                        ...
                        <CardItem style={{backgroundColor:"#680931"}}>
                            <Text style={{color:"#fff", fontSize:30, marginBottom: 10}} >Get an email with tomorrow's weather</Text>
                        </CardItem>
                        <CardItem style={{backgroundColor:"#680931"}} >
                            <Text style={{color:"#fff", marginBottom: 5}}>
                                Receive an email with tomorrow's weather
                            </Text>
                        </CardItem>
                        <CardItem style={{backgroundColor:"#680931"}}>
